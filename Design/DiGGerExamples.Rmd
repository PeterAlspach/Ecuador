...
CRAN contains a number of trial design software packages (e.g., [dae](http://cran.espol.edu.ec/web/packages/dae/index.html)), but [`DiGGer`](http://www.austatgen.org/software/)^[At the time of writing this site appears to be down] is particularly good for breeding trials.  It is available both as a stand-alone executable and as an R-package.  Herein we discuss `r citation('DiGGer')[[1]]$note`.
